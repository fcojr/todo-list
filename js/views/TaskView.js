            ...
            <table class="table table-striped">
                ...
                ${doneTasks.map(doneTasks =>
                     `<tr>
                        ...
                        <td>${moment(doneTasks.dueDate).format("YYYY-MM-DD")}</td>
                        <td>${moment(doneTasks.creationTime).format("YYYY-MM-DD")}</td>
                        <td>
            ...
            <table class="table table-striped">
                ...
                ${postponeTasks.map(postponeTasks =>
                    `<tr>
                        ...
                        <td>${moment(postponeTasks.dueDate).format("YYYY-MM-DD")}</td>
                        <td>${moment(postponeTasks.creationTime).format("YYYY-MM-DD")}</td>
                        <td>
